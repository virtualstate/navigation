 ...
 * @experimental
 */
export class NavigationHistory<S extends object>  extends NavigationLocation implements History {
    ...
    async back(): Promise<void> {
        ...
        return this[AppLocationTransitionURL](back.url, () => this.#navigation.back());
    }
    ...
    async forward(): Promise<void> {
        ...
        return this[AppLocationTransitionURL](forward.url, () => this.#navigation.forward());
    }
    ...
    async go(delta?: number): Promise<void> {
        ...
        const entries = this.#navigation.entries();
        const { currentEntry: { index } } = this.#navigation;
 ...
 * @internal
 */
export class NavigationSync<S extends object> extends NavigationHistory<S> implements NavigationHistory<S>, NavigationLocation {
