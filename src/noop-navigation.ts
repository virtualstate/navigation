import {
    Navigation, NavigationEventMap,
    NavigationHistoryEntry,
    NavigationNavigateOptions,
    NavigationNavigationOptions,
    NavigationReloadOptions,
    NavigationResult, NavigationUpdateCurrentOptions
...
export class NoOperationNavigation extends NavigationEventTarget<NavigationEventMap> implements Navigation {
    ...
    async updateCurrentEntry(options: NavigationUpdateCurrentOptions): Promise<void> {
        return undefined;
    }
