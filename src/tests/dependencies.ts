...
export const DependenciesHTML = `<script type="importmap">${JSON.stringify(DependenciesJSON, undefined, "  ")}</script>`
...
export const DependenciesSyncHTML = `<script type="importmap">${JSON.stringify(DependenciesSyncJSON, undefined, "  ")}</script>`