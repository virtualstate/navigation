...
export function removeEventListener(type: string, callback: EventCallback, options?: EventTargetAddListenerOptions): void
export function removeEventListener(type: string, callback: Function, options?: EventTargetAddListenerOptions): void
export function removeEventListener(type: string, callback: Function, options?: EventTargetAddListenerOptions): void {
